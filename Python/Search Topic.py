...
def load_api():
    ...
    access_secret = 'Tj9neSksnCtQGa6SdmVYSc0jDIW0udDgz204e1RVW4Oel'
...
def main():
    ...
    search_phrases=[];
    search_phrases=input("Enter Search Term:  ").split(" ")
    ...
    INDIA = '28.01744, 97.40238,-1500'         # states (and a large portion of Canada)
