...
jQuery(".single-post-content p a[href$='.jpg'], .single-post-content p a[href$='.jpeg'], .single-post-content p a[href$='.png'], .single-post-content p a[href$='.gif']").each(function() {
	jQuery(this).magnificPopup({
		type: 'image'
	});
});