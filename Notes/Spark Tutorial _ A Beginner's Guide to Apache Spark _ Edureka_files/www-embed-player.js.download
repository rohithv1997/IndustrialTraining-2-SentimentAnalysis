...
t("ytLoggingTransportDispatchedStats_",gf,void 0);var hf=u("ytLoggingTransportCapturedTime_")||{};t("ytytLoggingTransportCapturedTime_",hf,void 0);function jf(a,b){df[a.endpoint]=b;if(a.Z){var c=a.Z;var d={};c.videoId?d.videoId=c.videoId:c.playlistId&&(d.playlistId=c.playlistId);ff[a.Z.token]=d;c=kf(a.endpoint,a.Z.token)}else c=kf(a.endpoint);c.push(a.ra);d=Number(T("web_logging_max_batch")||0)||20;c.length>=d?lf():mf()}
...
z(Wg,K);var Yg=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];k=Wg.prototype;k.ka=function(a,b){this.f||(Zg(this,a),$g(this,b),this.A&&ah(this))};
...
Ih.prototype.l=function(){Ue(this.i);this.b=null;Ih.o.l.call(this)};function Jh(){var a=Oa(Kh);return new L(function(b,c){a.P=function(a){ke(a)?b(a):c(new Lh("Request failed, status="+a.status,"net.badstatus"))};
a.onError=function(){c(new Lh("Unknown request error","net.unknown"))};
a.aa=function(){c(new Lh("Request timed out","net.timeout"))};
re("//googleads.g.doubleclick.net/pagead/id",a)})}
function Lh(a,b){B.call(this,a+", errorCode="+b);this.errorCode=b;this.name="PromiseAjaxError"}
n(Lh,B);function Mh(a){this.g=void 0===a?null:a;this.f=0;this.b=null}
Mh.prototype.then=function(a,b,c){return this.g?this.g.then(a,b,c):1===this.f&&a?(a=a.call(c,this.b),Yc(a)?a:Nh(a)):2===this.f&&b?(a=b.call(c,this.b),Yc(a)?a:Oh(a)):this};
Mh.prototype.getValue=function(){return this.b};
Xc(Mh);function Oh(a){var b=new Mh;a=void 0===a?null:a;b.f=2;b.b=void 0===a?null:a;return b}
function Nh(a){var b=new Mh;a=void 0===a?null:a;b.f=1;b.b=void 0===a?null:a;return b}
;function Ph(a){B.call(this,a.message||a.description||a.name)}
n(Ph,B);Ph.prototype.name="BiscottiError";function Qh(){B.call(this,"Biscotti ID is missing from server")}
n(Qh,B);Qh.prototype.name="BiscottiMissingError";var Kh={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Rh=null;function Sh(){if("1"===Ja(Q("PLAYER_CONFIG",{}),"args","privembed"))return cd(Error("Biscotti ID is not available in private embed mode"));Rh||(Rh=ed(Jh().then(Th),function(a){return Uh(2,a)}));
return Rh}
function Th(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new Qh;a=JSON.parse(a.substr(4));if((Ja(window,"settings","experiments","flags","html5_serverside_ignore_biscotti_id_on_retry")||Q("EXP_HTML5_SERVERSIDE_IGNORE_BISCOTTI_ID_ON_RETRY",!1)||T("html5_serverside_ignore_biscotti_id_on_retry"))&&1<(a.type||1))throw new Qh;a=a.id;Vh(a);Rh=Nh(a);Wh(18E5,2);return a}
function Uh(a,b){var c=new Ph(b);Vh("");Rh=Oh(c);0<a&&Wh(12E4,a-1);throw c;}
function Wh(a,b){U(function(){ed(Jh().then(Th,function(a){return Uh(b,a)}),la)},a)}
function Vh(a){t("yt.ads.biscotti.lastId_",a,void 0)}
;function Xh(){}
function Yh(a){if("1"!==Ja(Q("PLAYER_CONFIG",{}),"args","privembed")){a&&!u("yt.ads.biscotti.getId_")&&t("yt.ads.biscotti.getId_",Sh,void 0);try{try{var b=u("yt.ads.biscotti.getId_");var c=b?b():Sh()}catch(d){c=cd(d)}c.then(Zh,Xh);U(Yh,18E5)}catch(d){S(d)}}}
var $h=0;
function Zh(a){a:{try{var b=window.top.location.href}catch(Ra){b=2;break a}b=null!=b?b==window.document.location.href?0:1:2}b={dt:lc,flash:bb||"0",frm:b};b.u_tz=-(new Date).getTimezoneOffset();var c=void 0===c?A:c;try{var d=c.history.length}catch(Ra){d=0}b.u_his=d;b.u_java=!!A.navigator&&"unknown"!==typeof A.navigator.javaEnabled&&!!A.navigator.javaEnabled&&A.navigator.javaEnabled();A.screen&&(b.u_h=A.screen.height,b.u_w=A.screen.width,b.u_ah=A.screen.availHeight,b.u_aw=A.screen.availWidth,b.u_cd=
...
wa.visibilityState||""]||0,wgl:!!A.WebGLRenderingContext};for(var Id in za)b[Id]=za[Id]}b.bsq=$h++;xe("//www.youtube.com/ad_data_204",{Da:!1,B:b})}
;function ai(){this.b=Q("ALT_PREF_COOKIE_NAME","PREF");var a=rc.get(""+this.b,void 0);if(a)for(var a=unescape(a).split("&"),b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Z[d]=c.toString())}}
ma(ai);var Z=u("yt.prefs.UserPrefs.prefs_")||{};t("yt.prefs.UserPrefs.prefs_",Z,void 0);function bi(a){if(/^f([1-9][0-9]*)$/.test(a))throw Error("ExpectedRegexMatch: "+a);}
...
ai.prototype.get=function(a,b){ci(a);bi(a);var c=void 0!==Z[a]?Z[a].toString():null;return null!=c?c:b?b:""};
ai.prototype.set=function(a,b){ci(a);bi(a);if(null==b)throw Error("ExpectedNotNull");Z[a]=b.toString()};
ai.prototype.remove=function(a){ci(a);bi(a);delete Z[a]};
ai.prototype.clear=function(){Z={}};var ei=null,fi=null,gi=null,hi={};function ii(a){of(a.payload_name,a.payload,rf,void 0,void 0)}
function ji(a){var b=a.id;a=a.ve_type;var c=Ze++;a=new Ye(void 0,a,c,void 0,void 0);hi[b]=a;b=Af();c=zf();b&&c&&pf(b,c,a)}
function ki(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(P("client-screen-nonce",b),P("ROOT_VE_TYPE",a),a=zf()))for(var c in hi){var d=hi[c];d&&pf(b,a,d)}}
function li(a){hi[a.id]=new Ye(a.tracking_params)}
function mi(a){var b=Af();a=hi[a.id];b&&a&&qf(rf,{click:{csn:b,visualElement:$e(a)}},void 0,void 0)}
function ni(a){a=a.ids;var b=Af();if(b){for(var c=[],d=0;d<a.length;d++){var e=hi[a[d]];e&&c.push(e)}c.length&&sf(b,c)}}
function oi(){var a=ei;a&&a.startInteractionLogging&&a.startInteractionLogging()}
...
t("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);Yh(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=Q("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);Q("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&sh(a.args);ei=a=nh(a);a.addEventListener("onScreenChanged",ki);a.addEventListener("onLogClientVeCreated",ji);a.addEventListener("onLogServerVeCreated",li);a.addEventListener("onLogToGel",ii);
a.addEventListener("onLogVeClicked",mi);a.addEventListener("onLogVesShown",ni);a.addEventListener("onReady",oi);b=Q("POST_MESSAGE_ID","player");Q("ENABLE_JS_API")?gi=new Fh(a):Q("ENABLE_POST_API")&&r(b)&&r(c)&&(fi=new Ih(window.parent,b,c),gi=new zh(a,fi.g));Q("BG_P")&&(Q("BG_I")||Q("BG_IU"))&&ee();Le()},void 0);
t("yt.www.watch.ads.restrictioncookie.spr",function(a){Ae(a+"mac_204?action_fcts=1");return!0},void 0);
var pi=Ed(function(){Jg("ol");var a=ai.getInstance(),b=1<window.devicePixelRatio;if(!!((di("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=di(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in Z)b.push(e+"="+escape(Z[e]));Bf(a,b.join("&"),63072E3)}}),qi=Ed(function(){var a=ei;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&(de=null);for(var a=0,b=Je.length;a<b;a++)Ie(Je[a]);Je.length=0;ae("//static.doubleclick.net/instream/ad_status.js");Ke=!1;P("DCLKSTAT",0);Jc(gi,fi);if(a=ei)a.removeEventListener("onScreenChanged",ki),a.removeEventListener("onLogClientVeCreated",ji),a.removeEventListener("onLogServerVeCreated",li),a.removeEventListener("onLogToGel",ii),a.removeEventListener("onLogVeClicked",mi),a.removeEventListener("onLogVesShown",ni),a.removeEventListener("onReady",
oi),a.destroy();hi={}});
window.addEventListener?(window.addEventListener("load",pi),window.addEventListener("unload",qi)):window.attachEvent&&(window.attachEvent("onload",pi),window.attachEvent("onunload",qi));}).call(this);
